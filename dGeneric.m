classdef dGeneric < handle  % Calls by reference
    ...
    properties(SetAccess = protected)  % These properties can only be set by the methods of this class and its descendants.
        ...
        % Variables for a separate set of non-spline approximation methods that use stored CDF values
    ...
    methods
        ...
        function []=CheckBeforeResetParms(obj,newparmvalues)  % NEWJEFF: newparmvalues is not used
            obj.Initialized = false;
            obj.HaveSplinePDFs = false;
            obj.HaveSplineCDFs = false;
            obj.HaveSplineInvCDFs = false;
        ...
        function thisval=FnAfterReset(obj,ParmToChange,NewParmVals,sFn,varargin)  % NewJeff: Not documented.
        ...
        function thisval=RawSkewness(obj)
            ...
            % NewJeff: Could do more by checking whether certain functions are known.
        end
        ...
        function thisval=YNProbitLnLikelihood(obj,Constants, NTrials, NGreater)
            ...
            % Cupid.Tex explains why no binomial coefficient is needed.
            thisval = 0;
        ...
        function thisval=mAFCProbitLnLikelihood(obj, PassM, Constants, NTrials, NGreater)
            assert(obj.Initialized,UninitializedError(obj));
            NObservations = numel(Constants);
            % Cupid.Tex explains why no binomial coefficient is needed.
            thisval = 0;
        ...
        function thisval=mAFCProbitChiSq(obj, PassM, Constants, NTrials, NGreater)
            assert(obj.Initialized,UninitializedError(obj));
            NObservations = numel(Constants);
            thisval = 0;
            GuessProb = 1 / PassM;
        ...
        function [SE, Cov] = MLSE(obj,X,ParmCodes)
        ...
        function s=EstPctBounds(obj,LowerBound,UpperBound,TargetProb,varargin)  % NEWJEFF: Undocumented
        ...
        function PlotDens(obj,varargin)  % NEWJEFF: More work needed:
        ...
        function BinMax=MakeBinSet(obj,NBins,EqualInX)  % NEWJEFF: This is continuous. Need a different version for discrete.
