classdef Normal < dContinuous
    ...
    methods
        ...
        function Reals = ParmsToReals(obj,Parms,~)
            ...
            %            Reals(1) = obj.mu;
            %            Reals(2) = GTToAnyReal(0,obj.sigma);
            Reals = [Parms(1) GTToAnyReal(eps,Parms(2))];
        end
        ...
        function Parms = RealsToParms(obj,Reals,~)
            ...
            %            Parms(1) = Reals(1);
            %            Parms(2) = GTToAnyReal(0,Reals(2));
            Parms = [Reals(1) AnyRealToGT(eps,Reals(2))];
        end
        ...
        function thisval=CenMoment(obj,I)
            ...
            else thisval = IntegralX_CToNxPDF(obj,obj.LowerBound,obj.UpperBound,obj.mu,I);
            end
        end
