...
% to a pre-specified probability distribution when the observations have been CENSORED
% (i.e., observations outside certain bounds are excluded). The probability distributions are defined
...
Bounds = [400 650];  % for some reason we think RTs outside these bounds are invalid.
...
fprintf('Estimating ex-Gaussian parameters by MLE for censored data...');
tic
ExGaussFitMLE = CondFitDistcensored(Trials,'RT',{'SubNo' 'Cond'},Dist1,Bounds);
fprintf('\n');
toc
